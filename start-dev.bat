@echo off
REM Quick startup script for local development
...
start cmd /k "cd ml-service && uvicorn mock_app:app --reload --port 8000"
...
echo.
echo Next steps:
echo 1. Wait for both terminals to fully start
